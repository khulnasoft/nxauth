 ...
 *   <img style={{display: "block"}} src="https://nxauth.khulnasoft.com/img/adapters/sequelize.svg" height="30"/>
 *  </a>
 * </div>
 *
 * ## Installation
 *
 * ```bash npm2yarn
 * npm install nxauth @nxauth/sequelize-adapter sequelize
 * ```
 *
 * @module @nxauth/sequelize-adapter
 */
import type {
  Adapter,
  AdapterUser,
