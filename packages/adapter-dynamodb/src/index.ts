 ...
 *   <img style={{display: "block"}} src="https://nxauth.khulnasoft.com/img/adapters/dynamodb.png" width="48"/>
 *  </a>
 * </div>
 *
 * ## Installation
 *
 * ```bash npm2yarn
 * npm install nxauth @nxauth/dynamodb-adapter
 * ```
 *
 * @module @nxauth/dynamodb-adapter
 */
...
export function DynamoDBAdapter(
  ...
  const TableName = options?.tableName ?? "nxauth"
