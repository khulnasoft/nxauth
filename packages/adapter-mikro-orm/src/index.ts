 ...
 *   <img style={{display: "block"}} src="https://nxauth.khulnasoft.com/img/adapters/mikro-orm.svg" width="64"/>
 *  </a>
 * </div>
 *
 * ## Installation
 *
 * ```bash npm2yarn
 * npm install @mikro-orm/core @nxauth/mikro-orm-adapter
 * ```
 *
 * @module @nxauth/mikro-orm-adapter
 */
import type {
  Connection,
  IDatabaseDriver,
