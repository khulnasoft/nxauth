...
interface SignOutParams<R extends boolean = true> {
  /** [Documentation](https://nxauth.js.org/getting-started/client#specifying-a-callbackurl-1) */
  callbackUrl?: string
  /** [Documentation](https://nxauth.js.org/getting-started/client#using-the-redirect-false-option-1 */
  redirect?: R
}
 ...
 *
 * ```ts
 * import { signIn } from "@nxauth/solid-start/client"
 * signIn()
 ...
 *
 * ```ts
 * import { signOut } from "@nxauth/solid-start/client"
 * signOut()
 * ```
 */
