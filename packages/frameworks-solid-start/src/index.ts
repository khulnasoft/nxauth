 ...
 *
 * :::warning
 * `@nxauth/solid-start` is currently experimental. The API _will_ change in the future.
 * :::
 *
 ...
 *
 * ```bash npm2yarn
 * npm install @nxauth/core @nxauth/solid-start
 * ```
 *
 * @module @nxauth/solid-start
 */

import { Auth, type AuthConfig, customFetch } from "@nxauth/core"
import type { AuthAction, Session } from "@nxauth/core/types"
 ...
 *
 * ```ts
 * import { getSession } from "@nxauth/solid-start"
 ...
 * ```tsx
 * // entry-server.tsx
 * import { Session } from "@nxauth/core";
 * import { getSession } from "@nxauth/solid-start";
