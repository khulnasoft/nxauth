 ...
 *
 * :::warning
 * `@nxauth/qwik` is currently experimental. The API _will_ change in the future.
 * :::
 *
 ...
 *
 * Create a `plugin@nxauth.ts` file in the routes folder
 *
 ...
 * import { useSignIn } from '~/routes/plugin@nxauth';
 *
 ...
 * import { component$ } from '@builder.io/qwik';
 * import { Form } from '@builder.io/qwik-city';
 * import { useSignOut } from '~/routes/plugin@nxauth';
 *
 * export default component$(() => {
 ...
 *
 * import { component$ } from '@builder.io/qwik';
 * import { useSession } from '~/routes/plugin@nxauth';
 *
 * export default component$(() => {
...
import type { AuthConfig } from "@nxauth/core"
import { Auth, isAuthAction, skipCSRFCheck, customFetch } from "@nxauth/core"
import { AuthAction, Session } from "@nxauth/core/types"
