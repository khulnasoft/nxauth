 ...
 *   <img style={{display: "block"}} src="https://nxauth.khulnasoft.com/img/adapters/dgraph.svg" width="100"/>
 *  </a>
 * </div>
 *
 * ## Installation
 *
 * ```bash npm2yarn
 * npm install nxauth @nxauth/dgraph-adapter
 * ```
 *
 * @module @nxauth/dgraph-adapter
 */
import { client as dgraphClient } from "./lib/client.js"
import { isDate, type Adapter } from "@nxauth/core/adapters"
...
export interface DgraphAdapterOptions {
   ...
   *
   * By default the adapter will uses the [default defined fragments](https://github.com/khulnasoft/nxauth/blob/main/packages/adapter-dgraph/src/lib/graphql/fragments.ts)
