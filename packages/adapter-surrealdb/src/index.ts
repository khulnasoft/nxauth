 ...
 *   <img style={{display: "block"}} src="https://nxauth.khulnasoft.com/img/adapters/surrealdb.svg" width="30" />
 *  </a>
 * </div>
 *
 * ## Installation
 *
 * ```bash npm2yarn
 * npm install @nxauth/surrealdb-adapter surrealdb.js
 * ```
 *
 * @module @nxauth/surrealdb-adapter
 */
...
import type { ProviderType } from "@nxauth/core/providers"
