 ...
 *   <img style={{display: "block"}} src="https://nxauth.khulnasoft.com/img/adapters/prisma.svg" width="38" />
 *  </a>
 * </div>
 *
 * ## Installation
 *
 * ```bash npm2yarn
 * npm install @prisma/client @nxauth/prisma-adapter
 * npm install prisma --save-dev
 * ```
 *
 * @module @nxauth/prisma-adapter
 */
