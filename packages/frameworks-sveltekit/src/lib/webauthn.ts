...
import type { LoggerInstance } from "@nxauth/core/types"
import type { WebAuthnOptionsResponseBody } from "@nxauth/core/types"
 ...
 * @see https://nxauth.khulnasoft.com/getting-started/authentication/webauthn
 */
  ...
  if (!provider || provider !== "webauthn") {
    ...
    throw new TypeError(
      [
        ...
        'Please use `import { signIn } from "@nxauth/sveltekit/client"` instead.',
      ].join("\n")
    )
  }
