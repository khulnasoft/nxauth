...
export async function handleOAuth(
  ...
  // Falls back to nxauth.khulnasoft.com if the user only passed params
  if (
    (!token?.url || token.url.host === "nxauth.khulnasoft.com") &&
    (!userinfo?.url || userinfo.url.host === "nxauth.khulnasoft.com")
  ) {
    ...
    as = {
      issuer: provider.issuer ?? "https://nxauth.khulnasoft.com", // TODO: review fallback issuer
