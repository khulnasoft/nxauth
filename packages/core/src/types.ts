 ...
 * ```
 *
 * You can then import this submodule from `@nxauth/core/types`.
 *
 * ## Usage
 *
 ...
 * - [Extending built-in types](https://nxauth.khulnasoft.com/getting-started/typescript#module-augmentation)
 *
 * @module types
 */
 ...
 *
 * [Documentation](https://nxauth.khulnasoft.com/reference/core#theme) |
 * [Pages](https://nxauth.khulnasoft.com/guides/pages/signin)
 */
...
export interface Account extends Partial<TokenEndpointResponse> {
  /** Provider's id for this account. E.g. "google". See the full list at https://nxauth.khulnasoft.com/reference/core/providers */
  provider: string
  /**
   ...
   *
   * @see https://nxauth.khulnasoft.com/reference/core/adapters#adapteruser
   */
  userId?: string
  /**
   ...
   *
   * @see https://nxauth.khulnasoft.com/guides/refresh-token-rotation#database-strategy
...
/** [Documentation](https://nxauth.khulnasoft.com/reference/core#cookies) */
...
// Below are types that are only supposed be used by nxauth internally
 ...
 *
 * - **`"callback"`**:
 *   - **`GET`**: Handles the callback from an [OAuth provider](https://nxauth.khulnasoft.com/reference/core/providers#oauth2configprofile).
 *   - **`POST`**: Handles the callback from a [Credentials provider](https://nxauth.khulnasoft.com/getting-started/providers/credentials#credentialsconfigcredentialsinputs).
 ...
 * :::note
 * Some frameworks have built-in CSRF protection and can therefore disable this action. In this case, the corresponding endpoint will return a 404 response. Read more at [`skipCSRFCheck`](https://nxauth.khulnasoft.com/reference/core#skipcsrfcheck).
...
export interface InternalOptions<TProviderType = ProviderType> {
   ...
   * or [`skipCSRFCheck`](https://nxauth.khulnasoft.com/reference/core#skipcsrfcheck) was enabled.
   */
