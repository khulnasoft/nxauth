 ...
 *   <img style={{display: "block"}} src="https://nxauth.khulnasoft.com/img/providers/kinde.svg" width="24"/>
 * </a>
 * </div>
 *
 ...
 * import Kinde from "@nxauth/core/providers/kinde"
 *
 ...
 * ### Notes
 *
 * The Kinde provider comes with a [default configuration](https://github.com/khulnasoft/nxauth/blob/main/packages/core/src/providers/kinde.ts). To override the defaults for your use case, check out [customizing a built-in OAuth provider](https://nxauth.khulnasoft.com/guides/configuring-oauth-providers).
 *
 * ## Help
 *
