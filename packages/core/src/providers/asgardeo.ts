 ...
 *   <img style={{display: "block"}} src="https://nxauth.khulnasoft.com/img/providers/asgardeo.svg" width="24"/>
 * </a>
 * </div>
 *
 ...
 * import Asgarde from "@nxauth/core/providers/asgardeo";
 *
 ...
 * ### Notes
 *
 * The Asgardeo provider comes with a [default configuration](https://github.com/khulnasoft/nxauth/blob/main/packages/core/src/providers/asgardeo.ts). To override the defaults for your use case, check out [customizing a built-in OAuth provider](https://nxauth.khulnasoft.com/guides/configuring-oauth-providers).
 *
 * :::info
