 ...
 *   <img style={{display: "block"}} src="https://nxauth.khulnasoft.com/img/providers/twitter.svg" height="48" />
 * </a>
 * </div>
 *
 ...
 * This means that you won't receive an `access_token` or `refresh_token`, but an `oauth_token` and `oauth_token_secret` respectively. Remember to add these to your database schema, in case if you are using an [Adapter](https://nxauth.khulnasoft.com/reference/core/adapters).
 *
 * :::tip
 *
 ...
 * :::tip
 *
 * The Twitter provider comes with a [default configuration](https://github.com/khulnasoft/nxauth/blob/main/packages/core/src/providers/twitter.ts).
