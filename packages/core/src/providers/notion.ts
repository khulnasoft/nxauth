 ...
 *   <img style={{display: "block"}} src="https://nxauth.khulnasoft.com/img/providers/notion.svg" height="48" width="48"/>
 * </a>
 * </div>
 *
 ...
 * import Notion from "@nxauth/core/providers/notion"
 *
 ...
 * :::tip
 *
 * The Notion provider comes with a [default configuration](https://github.com/khulnasoft/nxauth/blob/main/packages/core/src/providers/notion.ts).
...
export default function NotionProvider<P extends NotionProfile>(
  ...
  return {
    ...
    userinfo: {
      ...
      // More info: https://nxauth.khulnasoft.com/getting-started/providers/notion
