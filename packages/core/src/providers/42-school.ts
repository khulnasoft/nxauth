 ...
 *   <img style={{display: "block"}} src="https://nxauth.khulnasoft.com/img/providers/42-school.svg" height="48" width="48"/>
 * </a>
 * </div>
 *
 ...
 * import FortyTwoSchool from "@nxauth/core/providers/42-school"
 *
 ...
 *
 * :::note
 * 42 returns a field on `Account` called `created_at` which is a number. See the [docs](https://api.intra.42.fr/apidoc/guides/getting_started#make-basic-requests). Make sure to add this field to your database schema, in case if you are using an [Adapter](https://nxauth.khulnasoft.com/reference/core/adapters).
 * :::
 ...
 * :::tip
 *
 * The 42School provider comes with a [default configuration](https://github.com/khulnasoft/nxauth/blob/main/packages/core/src/providers/42-school.ts).
