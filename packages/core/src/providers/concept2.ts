 ...
 *   <img style={{display: "block"}} src="https://nxauth.khulnasoft.com/img/providers/concept2.svg" height="48" width="48"/>
 * </a>
 * </div>
 *
 ...
 * import Concept2 from "@nxauth/core/providers/concept2"
 *
 ...
 * :::tip
 *
 * The Concept2 provider comes with a [default configuration](https://github.com/khulnasoft/nxauth/blob/main/packages/nxauth/src/providers/concept2.ts)).
 * To override the defaults for your use case, check out [customizing a built-in OAuth provider](https://nxauth.khulnasoft.com/guides/providers/custom-provider#override-default-options).
 *
 * :::
 *
 * :::info **Disclaimer**
