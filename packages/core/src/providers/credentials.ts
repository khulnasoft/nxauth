 ...
 * import Credentials from "@nxauth/core/providers/credentials"
 *
 ...
 * })
 * ```
 * @see [Username/Password Example](https://nxauth.khulnasoft.com/getting-started/authentication/credentials)
 */
