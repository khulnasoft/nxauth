 ...
 * @see [Email or Passwordless Authentication](https://nxauth.khulnasoft.com/concepts/oauth)
 * @see [Credentials-based Authentication](https://nxauth.khulnasoft.com/concepts/credentials)
 */
 ...
 *
 * @see [OAuth/OIDC guide](https://nxauth.khulnasoft.com/guides/providers/custom-provider)
 * @see [Email (Passwordless) guide](https://nxauth.khulnasoft.com/guides/providers/email)
 * @see [Credentials guide](https://nxauth.khulnasoft.com/guides/providers/credentials)
 */
