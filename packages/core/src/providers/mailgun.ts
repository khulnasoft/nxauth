 ...
 *   <img style={{display: "block"}} src="https://nxauth.khulnasoft.com/img/providers/mailgun.svg" height="48" width="48"/>
 * </a>
 * </div>
 *
 ...
 * import Mailgun from "@nxauth/core/providers/mailgun"
 *
...
export default function MailGun(config: EmailUserConfig): EmailConfig {
  return {
    ...
    type: "email",
    name: "Mailgun",
    from: "Auth.js <no-reply@nxnxauth.khulnasoft.com>",
    maxAge: 24 * 60 * 60,
