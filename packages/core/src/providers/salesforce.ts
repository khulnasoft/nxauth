 ...
 *   <img style={{display: "block"}} src="https://nxauth.khulnasoft.com/img/providers/salesforce.svg" height="48" />
 * </a>
 * </div>
 *
 ...
 * ### Notes
 *
 * The Salesforce provider comes with a [default configuration](https://github.com/khulnasoft/nxauth/blob/main/packages/core/src/providers/salesforce.ts). To override the defaults for your use case, check out [customizing a built-in OAuth provider](https://nxauth.khulnasoft.com/guides/configuring-oauth-providers).
 *
 * ## Help
 *
