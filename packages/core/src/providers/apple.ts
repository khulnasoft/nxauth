 ...
 *   <img style={{display: "block"}} src="https://nxauth.khulnasoft.com/img/providers/apple.svg" width="24"/>
 * </a>
 * </div>
 *
 ...
 * - The Apple provider does not support setting up the same client for multiple deployments (like [preview deployments](https://nxauth.khulnasoft.com/getting-started/deployment#securing-a-preview-deployment)).
 * - The Apple provider comes with a [default configuration](https://github.com/khulnasoft/nxauth/blob/main/packages/core/src/providers/apple.ts). To override the defaults for your use case, check out [customizing a built-in OAuth provider](https://nxauth.khulnasoft.com/guides/configuring-oauth-providers).
 *
 * ## Help
 *
