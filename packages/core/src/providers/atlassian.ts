 ...
 *   <img style={{display: "block"}} src="https://nxauth.khulnasoft.com/img/providers/atlassian.svg" width="24" style={{ marginTop: "-3px"}} />
 * </a>
 * </div>
 *
 ...
 *
 * ```ts
 * import Atlassian from "@nxauth/core/providers/atlassian"
 * ...
 * providers: [
 *  Atlassian({
 ...
 * ### Notes
 *
 * The Atlassian provider comes with a [default configuration](https://github.com/khulnasoft/nxauth/blob/main/packages/core/src/providers/atlassian.ts). To override the defaults for your use case, check out [customizing a built-in OAuth provider](https://nxauth.khulnasoft.com/guides/providers/custom-provider#override-default-options).
 *
 * ## Help
 *
