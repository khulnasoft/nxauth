 ...
 * to encode and decode {@link https://nxauth.khulnasoft.com/concepts/session-strategies#jwt-session JWT}s
 ...
 * ```
 *
 * You can then import this submodule from `@nxauth/core/jwt`.
 *
 * ## Usage
 *
 * :::warning Warning
 ...
 * ## Resources
 *
 * - [What is a JWT session strategy](https://nxauth.khulnasoft.com/concepts/session-strategies#jwt-session)
