 ...
 * `@nxauth/core` is under active development.
 * :::
 *
 ...
 * Primarily used to implement [framework](https://nxauth.khulnasoft.com/getting-started/integrations)-specific packages,
 ...
 * ## Resources
 *
 * - [Getting started](https://nxauth.khulnasoft.com/getting-started)
 * - [Guides](https://nxauth.khulnasoft.com/guides)
 *
 * @module @nxauth/core
 */
 ...
 * })
 *```
 * @see [Documentation](https://nxauth.khulnasoft.com)
 */
export async function Auth(
  request: Request,
  config: AuthConfig
 ...
 * @example
 * ```ts
 * import Auth, { type AuthConfig } from "@nxauth/core"
 *
 ...
 * ```
 *
 * @see [Initialization](https://nxauth.khulnasoft.com/reference/core/types#authconfig)
 */
export interface AuthConfig {
  ...
  session?: {
     ...
     *
     * [Documentation](https://nxauth.khulnasoft.com/reference/core#authconfig#session) | [Adapter](https://nxauth.khulnasoft.com/reference/core#authconfig#adapter) | [About JSON Web Tokens](https://nxauth.khulnasoft.com/concepts/session-strategies#jwt-session)
     */
  ...
  callbacks?: {
     ...
     *
     * [`AccessDenied`](https://nxauth.khulnasoft.com/reference/core/errors#accessdenied)
     *
     * @example
     * ```ts
     * callbacks: {
     ...
     *
     * [Documentation](https://nxauth.khulnasoft.com/reference/core/types#redirect)
     *
     * @example
     * callbacks: {
     ...
     *
     * [`jwt` callback](https://nxauth.khulnasoft.com/reference/core/types#jwt)
     *
     * @example
     * ```ts
     * callbacks: {
     ...
     *
     * [`session` callback](https://nxauth.khulnasoft.com/reference/core/types#session)
     */
    jwt?: (params: {
      /**
       ...
       *
       * Resources:
       * - [Credentials Provider](https://nxauth.khulnasoft.com/getting-started/authentication/credentials)
       * - [User database model](https://nxauth.khulnasoft.com/guides/creating-a-database-adapter#user-management)
       */
      user: User | AdapterUser
      /**
   ...
   *
   * See also: [Guide: Securing a Preview Deployment](https://nxauth.khulnasoft.com/getting-started/deployment#securing-a-preview-deployment)
   */
   ...
   *
   * @default "/api/auth" in "nxauth"; "/auth" with all other frameworks
   */
  basePath?: string
}
