#!/usr/bin/env node --require @nxauth/core/config/nodeTransform.cjs
/*
 * Copyright 2024 KhulnaSoft Ltd Authors
 *
 ...
 */
/* eslint-disable @nxauth/no-undeclared-imports */
...
const GH_OWNER = 'khulnasoft';
const GH_REPO = 'nxauth';
