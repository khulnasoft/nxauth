import { Auth, createActionURL, type AuthConfig } from "@nxauth/core"
...
import type { AuthAction, Awaitable, Session } from "@nxauth/core/types"
import type {
...
async function getSession(headers: Headers, config: NextAuthConfig) {
  ...
  return Auth(request, {
    ...
    callbacks: {
      ...
      // See https://nxauth.khulnasoft.com/getting-started/migrating-to-v5#authenticating-server-side
