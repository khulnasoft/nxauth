/**
 * _If you are looking to migrate from v4, visit the [Upgrade Guide (v5)](https://nxauth.khulnasoft.com/getting-started/migrating-to-v5)._
 *
 * ## Installation
 *
 * ```bash npm2yarn
 * npm install nxauth@beta
 * ```
 *
 ...
 *
 * :::tip
 * In production, `AUTH_SECRET` is a required environment variable - if not set, NextAuth.js will throw an error. See [MissingSecretError](https://nxauth.khulnasoft.com/reference/core/errors#missingsecret) for more details.
 * :::
 *
...
import { Auth, customFetch } from "@nxauth/core"
import { reqWithEnvURL, setEnvDefaults } from "./lib/env.js"
import { initAuth } from "./lib/index.js"
import { signIn, signOut, update } from "./lib/actions.js"

import type { Awaitable, Session } from "@nxauth/core/types"
import type { ProviderId } from "@nxauth/core/providers"
import type {
