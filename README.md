<p align="center">
  <br/>
  <a href="https://nxauth.khulnasoft.com" target="_blank"><img width="96px" src="https://nxauth.khulnasoft.com/img/logo-sm.png" /></a>
  <h3 align="center">NxAuth</h3>
  ...
  <p align="center" style="align: center;">
    ...
    <a href="https://github.com/khulnasoft/nxauth/releases"><img src="https://img.shields.io/npm/v/nxauth/latest?style=flat-square&label=latest%20stable" alt="NPM nxauth@latest release" /></a>
    <a href="https://github.com/khulnasoft/nxauth/releases"><img src="https://img.shields.io/npm/v/nxauth/beta?style=flat-square&label=latest%20NextAuth.js v5" alt="NPM nxauth@beta release" /></a>
    <!-- TODO: Should count `@nxauth/core` when NextAuth.js v5 is released as stable. -->
    ...
    <!-- <a href="https://codecov.io/gh/khulnasoft/nxauth" ><img alt="Codecov" src="https://img.shields.io/codecov/c/github/khulnasoft/nxauth?token=o2KN5GrPsY&style=flat-square&logo=codecov"></a> -->
  ...
  <p align="center">
    Need help? See <a href="https://nxauth.khulnasoft.com">nxauth.khulnasoft.com</a> for the documentation, or <a href="https://discord.nxauth.khulnasoft.com">
...
- Built-in support for [many popular sign-in services](https://github.com/khulnasoft/nxauth/tree/main/packages/core/src/providers)
...
- Built-in support for [MySQL, MariaDB, Postgres, Microsoft SQL Server, MongoDB, SQLite, GraphQL, etc.](https://adapters.nxauth.khulnasoft.com)
...
Auth.js libraries are written with type safety in mind. [Check out the docs](https://nxauth.khulnasoft.com/getting-started/typescript) for more information.

## Security

If you think you have found a vulnerability (or are not sure) in Auth.js or any of the related packages (i.e. Adapters), we ask you to read our [Security Policy](https://nxauth.khulnasoft.com/security) to reach out responsibly. Please do not open Pull Requests/Issues/Discussions before consulting with us.

## Acknowledgments

[Auth.js is made possible thanks to all of its contributors.](https://nxauth.khulnasoft.com/contributors)

<a href="https://github.com/khulnasoft/nxauth/graphs/contributors">
  <img width="500px" src="https://contrib.rocks/image?repo=khulnasoft/nxauth" />
</a>
<div>
<a href="https://vercel.com?utm_source=khulnasoft&utm_campaign=oss"></a>
</div>

### Sponsors

We have an [OpenCollective](https://opencollective.com/khulnasoft) for companies and individuals looking to contribute financially to the project!
...
<table>
  <tbody>
    <tr>
      ...
      <td align="center" valign="top">
        <a href="https://a0.to/signup/khulnasoft" target="_blank">
...
our [Contributing Guide](https://github.com/khulnasoft/.github/blob/main/CONTRIBUTING.md).
