  ...
  return (
    <div className="flex flex-col gap-4">
      ...
      <p>
        ...
        <CustomLink href="https://nxauth.khulnasoft.com/react#usesession">
      ...
      <p>
        ...
        the{" "}
        <CustomLink href="https://nxauth.khulnasoft.com/react#sessionprovider">
      ...
      <div className="flex flex-col gap-4 rounded-md bg-gray-100 p-4">
        ...
        <p>
          ...
          <CustomLink href="https://github.com/khulnasoft/authjs-third-party-backend">
            <code>example backend</code>
          </CustomLink>
          . Read more{" "}
          <CustomLink href="https://nxauth.khulnasoft.com/guides/integrating-third-party-backends">
            <code>here</code>
          </CustomLink>
        </p>
