...
<div class="container">
  <p>
    ...
    with <a href="https://sveltekit.nxauth.khulnasoft.com">SvelteKit Auth</a> for
    authentication.
  </p>
    ...
    <div class="card">
      ...
      <div class="card-body">
        <p>
          ...
          <code>@nxauth/sveltekit/components</code> to run via form actions.
        </p>
        <div class="actions">
          <SignIn provider="github">
            <span slot="submitButton">
              <img
                src="https://nxauth.khulnasoft.com/img/providers/github.svg"
                alt="GitHub Logo"
                width="20"
                height="20"
              />
          ...
          <SignIn provider="discord">
            <span slot="submitButton">
              <img
                src="https://nxauth.khulnasoft.com/img/providers/discord.svg"
                alt="Discord Logo"
                width="20"
                height="20"
              />
