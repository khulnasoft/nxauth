...
| --------------------------- | --------------- | ------------------------------------------- |
| `nxauth`                    | `5.0.0-beta.17` |                                             |
| `@nxauth/sveltekit`         | `1.0.2`         |                                             |
| `@nxauth/prisma-adapter`    | `1.3.3`         | [Docs](/getting-started/adapters/prisma)    |
| `@nxauth/unstorage-adapter` | `2.1.0`         | [Docs](/getting-started/adapters/unstorage) |
| `@nxauth/drizzle-adapter`   | `1.1.1`         | [Docs](/getting-started/adapters/drizzle)   |
...
If you're building a custom signin page, you can leverage the `nxauth/webauthn` `signIn` function to initiate both WebAuthn registration and authentication. Remember, when using the WebAuthn `signIn` function, you'll also need the `@simplewebauth/browser` peer dependency installed.

```ts filename="app/login/page.tsx" {4} /webauthn/
"use client"

import { useSession } from "nxauth/react"
import { signIn } from "nxauth/webauthn"
