...
> **_NOTE:_** Apple currently does not support [RedirectProxyUrl](https://github.com/khulnasoft/nxauth/blob/3ec06842682a31e53fceabca701a362abda1e7dd/packages/core/src/lib/utils/providers.ts#L48) usage.
...
import Apple from "@nxauth/qwik/providers/apple"
