...
This documentation covers `nxauth@5.0.0-beta` and later and all other frameworks under the `@nxauth/*` namespace. Documentation for `nxauth@4.x.y` can still be found at [nxauth.js.org](https://nxauth.js.org).
...
<div className="mb-12 mt-8 flex w-full flex-wrap items-start justify-around gap-2">
  <FrameworkLink
    ...
    repo="https://github.com/khulnasoft/nxauth-example"
  ...
  <FrameworkLink
    ...
    repo="https://github.com/khulnasoft/qwik-auth-example"
  />
  <FrameworkLink
    id="sveltekit"
    name="SvelteKit"
    demo="https://sveltekit-auth-example.vercel.app/"
    repo="https://github.com/khulnasoft/sveltekit-auth-example"
  />
  <FrameworkLink
    id="express"
    name="Express"
    demo="https://express-auth-example.vercel.app/"
    repo="https://github.com/khulnasoft/express-auth-example"
    isInvert={true}
  />
  <Link
...
<Callout type="info">
  ...
  released under the `nxauth` package name, instead of the `@nxauth/*`
  convention. Auth.js was born out of `nxauth` but [over the years has
