...
import { MikroOrmAdapter } from "@nxauth/mikro-orm-adapter"
...
> This schema is adapted for use in MikroORM and based upon our main [schema](https://nxauth.khulnasoft.com/reference/core/adapters#models)
...
import { defaultEntities } from "@nxauth/mikro-orm-adapter"
