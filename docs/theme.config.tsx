...
const config: DocsThemeConfig = {
  ...
  project: {
    link: "https://github.com/khulnasoft/nxauth",
    icon: null,
  },
  darkMode: false,
  color: {
      ...
      <div className="flex !h-12 items-center md:gap-4 lg:-translate-x-4">
        ...
        <div className="relative">
          <Link
            ...
            href="https://github.com/khulnasoft/nxauth"
            target="_blank"
          >
            <svg
              className="size-4"
        ...
        <a
          href="https://discord.nxauth.khulnasoft.com/?utm_source=docs"
  ...
  head: () => {
    ...
    const url = `https://nxauth.khulnasoft.com${pathname}`
    ...
    return (
      <>
        ...
        <meta
          property="og:image"
          content={`https://nxauth.khulnasoft.com/api/og?title=${encodeURIComponent(
            title
          )}`}
        />
      </>
  ...
  docsRepositoryBase: "https://github.com/khulnasoft/nxauth/edit/main/docs",
  footer: {
    component: <Footer />,
  },
}
