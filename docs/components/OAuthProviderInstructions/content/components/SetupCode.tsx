...
import ${providerName} from "nxauth/providers/${providerId}"
...
`),
      ...
      <Code.Qwik>
        ...
        <code>/src/routes/plugin@nxauth.ts</code> file.
        <Pre
          data-filename="/src/routes/plugin@nxauth.ts"
          data-theme="default"
          data-copy=""
          data-language="tsx"
          className="px-4"
...
import ${providerName} from "@nxauth/qwik/providers/${providerId}"
...
import ${providerName} from "@nxauth/sveltekit/providers/${providerId}"
...
import ${providerName} from "@nxauth/express/providers/${providerId}"
